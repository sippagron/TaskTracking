...
public class EditGeneralController implements Initializable {
    ...
    public void setGeneralWork(GeneralWork generalWork){
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Platform.runLater(new Runnable() {
            public void run() {
                jobname.setText(generalWork.showJobName());
                date.setValue(generalWork.showDateStart());
                timestart1.setText(String.valueOf(generalWork.showHour1()));
                timestart2.setText(String.valueOf(generalWork.showMinute1()));
                timeend1.setText(String.valueOf(generalWork.showHour2()));
                timeend2.setText(String.valueOf(generalWork.showMinute2()));
                priority.setText(String.valueOf(generalWork.showPriority()));
                category.setText(generalWork.showCategory());
            }
        });
    }
    ...
    public void handleUseSaveButton(ActionEvent actionEvent){
        try {
            ...
            fileManager.editFileGeneralList(generalWork.showCount(),jobname.getText(),priority.getText(),timestart1.getText(),timestart2.getText()
    ...
    public void handleUseDeleteButton(ActionEvent actionEvent) {
        FileManager fileManager = new FileManager();
        fileManager.deleteFileGeneralList(generalWork.showCount());
        ((Stage) ((Button) actionEvent.getSource()).getScene().getWindow()).close();
    }
}
