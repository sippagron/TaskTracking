...
public class EditRegularController implements Initializable {
    RegularWork regularWork;
    @FXML
    private TextField jobname,timestart1,timestart2,timeend1,timeend2,priority,category;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Platform.runLater(new Runnable() {
            public void run() {
                jobname.setText(regularWork.showJobName());
                date.setValue(regularWork.showDateStart());
                timestart1.setText(String.valueOf(regularWork.showHour1()));
                timestart2.setText(String.valueOf(regularWork.showMinute1()));
                timeend1.setText(String.valueOf(regularWork.showHour2()));
                timeend2.setText(String.valueOf(regularWork.showMinute2()));
                priority.setText(String.valueOf(regularWork.showPriority()));
                category.setText(regularWork.showCategory());
            }
        });
    }
    ...
    public void handleUseSaveButton(ActionEvent actionEvent) {
        try {
            ...
            if(jobname.getText().equals("")||date.getValue() == null||timestart1.getText().equals("")||timestart2.getText().equals("")
            ...
            if (new FileManager().checkFileNameRegular(jobname.getText())){
            ...
            fileManager.editFileRegularList(regularWork.showCount(),jobname.getText(),priority.getText(),timestart1.getText(),timestart2.getText()
    ...
    public void handleUseDeleteButton(ActionEvent actionEvent) {
        FileManager fileManager = new FileManager();
        fileManager.deleteFileRegularList(regularWork.showCount());
        ((Stage) ((Button) actionEvent.getSource()).getScene().getWindow()).close();
    }
}
